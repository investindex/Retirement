...
The figure below illustrates this process. It shows your cumulative contributions to retirement savings (purple) as well as the value of your nest egg as it grows over time (red). Notice how the value of the nest egg explodes in the last ten years. This is how any exponential process looks, but it underlines the importance of beginning as early as possible. Every year delayed is one year less of that ever-growing explosion at the end.
